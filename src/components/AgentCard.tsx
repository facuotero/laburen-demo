...
const agentGroups = {
  ...
  platforms: [
    {
      ...
      description: "Connect and authenticate your AI agents with multiple platforms",
    },
    {
      name: "Kommo",
      role: "Soporte y Post-Venta",
      avatar: "/avatars/avatar_wt_consu.svg",
      description: "Encargada de asesorar el cliente en todo el proceso despues de la compra",
    },
    {
      name: "Cal.com",
      role: "Soporte y Post-Venta",
  ...
  integrations: [
    ...
    },
    {
      ...
      description: "Optimizes sales, inventory, and internal processes with ease",
    },
    {
      name: "Google Drive",
      role: "Storage",
